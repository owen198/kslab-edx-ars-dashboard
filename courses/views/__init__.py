...
class CourseHome(CourseTemplateWithNavView):
    ...
    def get_table_items(self):
        ...
        engagement_items['items'].append({
            'title': _('Who are at-risk students?'),
            'cid': ['course-v1:CYCUx+QA75+16001','edX/DemoX/Demo_Course'],
            'view': 'courses:engagement:risk',
            'breadcrumbs': [_('Risk')]
        })
        engagement_items['items'].append({
            'title': _('Who are at-risk students?'),
            'cid': ['course-v1:CYCUx+BJ17+16002', 'edX/DemoX/Demo_Course'],
            'view': 'courses:engagement:risk2',
            'breadcrumbs': [_('Risk')]
        })
        engagement_items['items'].append({
            'title': _('What is students\' video viewing behavior?'),
            'cid': ['course-v1:CYCUx+QA75+16001', 'edX/DemoX/Demo_Course'],
            'view': 'http://140.115.187.167/demo_test2/courseView.php?cid=course-v1%3ACYCUx%2BQA75%2B16001',
            'breadcrumbs': [_('Videos')]
        })
        engagement_items['items'].append({
            'title': _('What is students\' video viewing behavior?'),
            'cid': ['course-v1:CYCUx+BJ17+16002', 'edX/DemoX/Demo_Course'],
            'view': 'http://140.115.187.167/demo_test/courseView.php?cid=course-v1:CYCUx%2BBJ17%2B16002',
            'breadcrumbs': [_('Videos')]
        })
